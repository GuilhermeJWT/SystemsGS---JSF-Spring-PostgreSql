...
public abstract class BeanReportView extends BeanViewAbstract {
	...
	public StreamedContent getArquivoReport() throws Exception {
		return getReportUtil().geraRelatorio(getListaDataBeanCollectionReport(), getParametrosRelatorio(),
				getNomeRelatorioJasper(), getNomeRelatorioSaida(), getTipoRalatorio());
	}

	public int getTipoRalatorio() {
		return tipoRalatorio;
	}

	public void setTipoRalatorio(int tipoRalatorio) {
		this.tipoRalatorio = tipoRalatorio;
	}
